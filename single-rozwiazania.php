...
<div class="grid_7 "><p><br/><span style="text-transform:uppercase; text-decoration: underline;"><?php echo ${'tab'.$i}; ?>:</span><br/><br/></p><?php echo ${'tab'.$i.'l'}; ?></div>
...
<div class="clear"></div>
<div class="hr"></div>
<h2 style="font-family: 'Aller Regular'; text-align:center">Sales & marketing recruitment.</h2>
