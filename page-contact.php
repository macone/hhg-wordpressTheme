...
<div class="container">
	<div class="row justify-content-center" style="margin-top:50px">
		<div class="col-4 text-center">
			<img src="<?php bloginfo('url'); ?>/wp-content/uploads/2012/08/Batenborch.jpg" style="max-width: 100%">
			<p>Partner HHG na rynkach europejskich</p>
			<a href="https://www.batenborch.com">www.batenborch.com</a>
		</div>
		<div class="col-4 text-center">
				<h5>HEADHUNTERS GROUP</h5> 

				<p>Sales & Marketing Recruitment</p> 
