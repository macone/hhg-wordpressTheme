<div id="slider" class="carousel slide" data-ride="carousel">
	...
	<a id="slide-prev" class="carousel-control-prev" href="#slider" role="button" data-slide="prev">
		<span class="carousel-control-prev-icon"></span>
	</a>
	<a id="slide-next" class="carousel-control-next" href="#slider" role="button" data-slide="next">
